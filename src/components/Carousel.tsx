  ...
  return (
    <div className="relative m-auto overflow-hidden rounded-md w-full lg:w-96 aspect-square md:aspect-video lg:aspect-square bg-gray-300">
      ...
      {images && images.length > 1 && <div className="flex justify-between">
        <div className="text-gray-200 absolute top-0 bottom-0 h-6 w-6 rounded-full px-1.5 py-1 mx-auto my-32 lg:my-48 bg-mainaccent-700 cursor-pointer" onClick={handlePrevious}>
          <svg
        ...
        <div className="right-0 text-gray-200 absolute top-0 bottom-0 h-6 w-6 rounded-full px-1.5 py-1 mx-auto my-32 lg:my-48 bg-mainaccent-700 cursor-pointer" onClick={handleNext}>
