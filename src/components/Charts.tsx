...
export function StarRating({ rating }: { rating: number }) {
    ...
    return (
        ...
        <svg x="0px" y="0px" viewBox={`0 0 ${width} ${height}`}>
            <text fontSize="1800" x="35%" y="50%" textAnchor="middle" dominantBaseline="middle" className="fill-mainaccent-700 font-semibold">
                {rating}
            </text>
            <text fontSize="1000" x="84%" y="58%" textAnchor="middle" dominantBaseline="middle" className="fill-gray-400 font-semibold ">
                /5
            </text>
            <g transform={`translate(0, ${height - 800})`} >
                ...
                {/* Gray Stars 500 for darkmode, 300 for lightmode */}
	...
	c-31.6,16.6-68.6-10.2-62.5-45.4l34.5-201c2.4-14-2.2-28.2-12.4-38.1l-146-142.3c-25.6-24.9-11.5-68.4,23.9-73.5l201.8-29.3
	c14-2,26.2-10.8,32.4-23.6l90.2-182.8C2868.2,9.5,2913.8,9.5,2929.6,41.5z"   />
	...
	c-31.6,16.6-68.6-10.2-62.5-45.4l34.5-201c2.4-14-2.2-28.2-12.4-38.1l-146-142.3c-25.6-24.9-11.5-68.4,23.9-73.5l201.8-29.3
	c14-2,26.2-10.8,32.4-23.6l90.2-182.8C3698.2,9.5,3743.8,9.5,3759.6,41.5z"   />
                </g>
